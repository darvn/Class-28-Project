...
function handlePlayerArrowCollision(index, arrows) {
  for (var i = 0; i < playerArrows.length; i++) {
    ...
    if (
     ...
     computer.loseLife(computerArcherLife);
     playerArrows[playerArrows.length - 1].body.position.x = 300
     playerArrows[playerArrows.length - 1].body.position.y = 1500
...
function handleComputerArrowCollision(index, arrows) {
  for (var i = 0; i < computerArrows.length; i++) {
    var baseCollision = Matter.SAT.collides(
    ...
    if (
      ...
      playerArcherLife -= 1;
      player.loseLife(playerArcherLife);
      computerArrows[computerArrows.length - 1].body.position.x = 300
      computerArrows[computerArrows.length - 1].body.position.y = 1500
